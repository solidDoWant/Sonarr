...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            SharedValidator.RuleFor(c => c.OidcAuthority).NotEmpty().When(c => c.OidcEnabled);
            SharedValidator.RuleFor(c => c.OidcClientId).NotEmpty().When(c => c.OidcEnabled);
            SharedValidator.RuleFor(c => c.OidcClientSecret).NotEmpty().When(c => c.OidcEnabled);
            SharedValidator.RuleFor(c => c.OidcUsernameClaim).NotEmpty().When(c => c.OidcEnabled);
        }
